...
![上极限和下极限示意图](assets/note-算法复杂度的渐进符号定义,证明与理解-2026-02-13.png)
...
### 渐进符号对比图
![渐进符号对比](assets/note-算法复杂度的渐进符号定义,证明与理解-2026-02-13-1.png)

### 常见复杂度增长曲线
![常见复杂度](assets/note-算法复杂度的渐进符号定义,证明与理解-2026-02-13-2.png)
